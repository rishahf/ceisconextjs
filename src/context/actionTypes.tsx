...
export const MODULE_PROFILE = 'lang_Profile'
export const MODULE_PROFILE_SIDEBAR = 'lang_Profile_sidebar'
export const MODULE_ORDER = 'lang_Orders'
export const MODULE_ADDRESS = 'lang_Address'
export const MODULE_COUPONS = 'lang_Coupons'
export const MODULE_REVIEW = 'lang_Review'
export const MODULE_WISHLIST = 'lang_Wishlist'
export const MODULE_NOTIFICATION = 'lang_Notifications'
export const MODULE_HELP = 'lang_Help'
export const MODULE_PAYMENT = 'lang_Payment'
export const MODULE_CART = 'lang_Cart'
export const MODULE_CONTACT_US = 'lang_Contact_Us'
export const MODULE_DEALS = 'lang_Deals'
export const MODULE_HEADER = 'lang_Header'
export const MODULE_HOME = 'lang_Home'
export const MODULE_SIGNUP = 'lang_SignUp'
export const MODULE_VERIFY_SOCIAL = 'lang_Verify_Social'
export const MODULE_RESET_PASSWORD = 'lang_Reset_password'
export const MODULE_SIGNIN = 'lang_SignIn'
export const MODULE_FOOTER = 'lang_Footer'
export const MODULE_SEARCH_PRODUCT = 'lang_Search_Product'
export const MODULE_PRODUCT_DETAIL = 'lang_Product_details'
